...
- State: IN PROGRESS (2026-09-15): implementation and local validation complete in .worktrees/issue-180; [PR #190](https://github.com/ludmila-omlopes/ludylops-live/pull/190) awaiting integration. Commands: db:baseline:check and db:baseline:ensure -- --apply. Validation: 351 tests (32 new), typecheck, lint and test-environment build. SQL/transaction behavior tested with an adapter fake; real database verification remains a deployment prerequisite. No shared database was changed.
