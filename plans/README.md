...
| 012  | Bound hot queries + HLTB refresh off request path | P2 | M | — | [#177](https://github.com/ludmila-omlopes/ludylops-live/issues/177) | IMPLEMENTED (783 tests, types/lint/build and browser QA; variant A; awaiting review/merge) |
