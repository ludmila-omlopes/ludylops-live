...
| 009  | Thread creator context + scope the quotes vertical (pilot + pattern doc) | P1 | L | 008, 017, 018 | [#173](https://github.com/ludmila-omlopes/ludylops-live/issues/173) | IMPLEMENTED (PR #197; 607 tests; DB rollout applied with temporary legacy compatibility, awaiting merge/deploy and cleanup) |
