...
| 008  | Add `creator_id` to operational tables (schema + backfill, no behavior change) | P1 | M | 014 | [#172](https://github.com/ludmila-omlopes/ludylops-live/issues/172) | TODO |
...
- **008 (TODO)** — schema groundwork: `creator_id` on the 16 surrogate-PK operational tables, backfilled to `creator_ludylops`. Non-breaking, no query changes.
