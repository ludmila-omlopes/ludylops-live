...
| 010  | Cut OBS overlay polling cost (intervals + live gating) | P1 | S | — | [#175](https://github.com/ludmila-omlopes/ludylops-live/issues/175) | IMPLEMENTED (765 tests, browser QA, lint/types/build; awaiting review/merge) |
