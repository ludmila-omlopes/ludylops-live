...
export const gameSuggestions = pgTable("game_suggestions", {
  ...
  hltbId: varchar("hltb_id", { length: 32 }),
  hltbName: varchar("hltb_name", { length: 255 }),
  ...
  steamCurrency: varchar("steam_currency", { length: 8 }),
  steamInitialPrice: integer("steam_initial_price"),
  steamFinalPrice: integer("steam_final_price"),
  steamDiscountPercent: integer("steam_discount_percent"),
  steamIsFree: boolean("steam_is_free").default(false).notNull(),
  steamMatchConfidence: varchar("steam_match_confidence", { length: 32 }),
  steamCheckedAt: timestamp("steam_checked_at", { withTimezone: true }),
  steamLastPriceAt: timestamp("steam_last_price_at", { withTimezone: true }),
  status: varchar("status", { length: 32 }).notNull(),
